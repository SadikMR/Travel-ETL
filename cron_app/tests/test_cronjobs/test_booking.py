...
def test_get_query_params(booking_cron):
...
def test_fetch_bookings(booking_cron, expected_bookings):
...
def test_transform_bookings(booking_cron,expected_bookings,transformed_bookings):
...
def test_load_bookings(booking_cron,transformed_bookings):
...
def test_run_success(booking_cron, expected_bookings, transformed_bookings):
...
def test_run_none_response(booking_cron, capsys):
...
def test_run_invalid_response(booking_cron, capsys):
...
def test_run_empty_response(booking_cron, capsys):
    booking_cron.fetch_bookings = MagicMock(return_value=[])
    booking_cron.transform_bookings = MagicMock()
    booking_cron.load_bookings = MagicMock()
...
def test_run_request_exception(booking_cron, capsys):
    booking_cron.fetch_bookings = MagicMock(
